...
public class Day01 {
    ...
    private int toCalibrationCodeWithLetter(String s) {
        String cleanedString = s.replaceAll("one", "o1e")
                .replaceAll("two", "t2w")
                ...
                .replaceAll("nine", "n9e");
        return toCalibrationCode(cleanedString);
    }

    private int toCalibrationCode(String s) {
        String cleanString = s.replaceAll("[^0-9]", "");
        return Integer.parseInt(cleanString.charAt(0) + "" + cleanString.charAt(cleanString.length() - 1));
    }
